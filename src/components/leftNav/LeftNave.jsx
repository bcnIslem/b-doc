...
const LeftNave = () => {
  ...
  const notifyLogout = () => {
    toast.success('Logout Seccessfully', { position: toast.POSITION.TOP_CENTER })
  }
  ...
  return (
    <>
        ...
        <Paper elevation={3} className={open ? `${classes.paper}` : `${classes.paper} ${classes.hide}`}>
          <Grid className={classes.top}>
            ...
            <Grid className={classes.userName}>
              ...
              <Paper className={classes.circle} >
                ...
                <Typography  variant='h6'>{doc.firstName[0].toUpperCase()}</Typography>
                <Typography  variant='h6'>{doc.lastName[0].toUpperCase()}</Typography>

              </Paper>
              <Typography className={classes.typo} variant='body1'>{doc.userName}</Typography>
          ...
          <Grid className={classes.stat}>
            ...
            <Paper className={classes.number} >
              <Grid>
                <Typography className={classes.typo} variant='body2'>{moment().format('LT')}</Typography>
                <Typography className={classes.typo} variant='body2'>{moment().format('L')}</Typography>
              </Grid>
            </Paper>
          ...
          <Grid className={classes.developer}>
            ...
            <Typography className={classes.item}>-</Typography>
            <Link style={{ textDecoration: 'none', color: 'black' }} to='/qa'>QA</Link>
          </Grid>
        </Paper>
    </>
  )
