...
const Auth = () => {
    ...
    const notifyConfirmPassword = () => {
        toast.warn(`check your new password`, { position: toast.POSITION.TOP_CENTER })
    }
                ...
                <Grid item className={classes.gridItem} xs={12} md={8} lg={6}>
                    <Paper className={classes.paper} elevation={6}>
                        <form autoComplete='off' noValidate className={classes.form} onSubmit={handleSubmit}>
                            ...
                            <FormControl className={classes.formControl} fullWidth variant="outlined">
                                ...
                                <OutlinedInput
                                    ...
                                    <InputAdornment position="end">
                                        ...
                                        edge="end"
                                        >
                                        {formData.showSecurityQuestion ? <MdVisibilityOff /> : <MdVisibility />}
                                        </IconButton>
                                    </InputAdornment>
                                    }
                            ...
                            <FormControl className={classes.formControl} fullWidth variant="outlined">
                                <InputLabel htmlFor="outlined-adornment-password">Answer to Security Question</InputLabel>
                                <OutlinedInput
                                    type={formData.showAnswerSecurityQuestion ? 'text' : 'password'}
                                    ...
                                    <InputAdornment position="end">
                                        ...
                                        edge="end"
                                        >
                                        {formData.showAnswerSecurityQuestion ? <MdVisibilityOff /> : <MdVisibility />}
                                        </IconButton>
                                    </InputAdornment>
                                    }
                            ...
                            <Button className={classes.buttonSubmit} variant='contained' size='large' type='submit' fullWidth >Reset Password</Button>
                            <Typography style={{ textDecoration: 'none' }} component={Link} to='/login' variant="body2" >Back</Typography>
                        </form>
                    </Paper>
                </Grid>
            </Grid>
