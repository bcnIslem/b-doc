...
const AddTreatment = () => {
  ...
  const patientToAddTreatment = useSelector(
    (state) => state.patients.patientToAddTreatment
  );
  ...
  const clear = () => {
    setMedicationsData([{ medicationId: "", name: "", rules: "" }]);
    setRulesData([
      {
        ruleId: "",
        rule: "",
                ...
                <Grid key={ind}>
                  <Grid className={classes.inline}>
                    <TextField
                      ...
                      value={ruledata.rule}
                      onChange={(e) =>
                        handleRulesInput(medication.name, ind, e)
                      }
                    />
