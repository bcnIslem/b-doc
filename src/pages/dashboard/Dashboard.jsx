...
import { endPatientToUpdate, getPatients, getStatistic, patientToAddTreatment, patientToUpdated } from '../../actions/patient'
...
// icons
import { RiHeartAddFill, RiHealthBookFill, RiEmotionUnhappyFill } from 'react-icons/ri'
                    ...
                    <Grid className={classes.right}>
                        ...
                        <Grid className={classes.insideleft}>
                            ...
                            <Grid className={classes.top}>
                                ...
                                <Paper className={classes.topPaper} elevation={3} component={Link} to='/home'>
                                ...
                                <Paper className={classes.topPaper} elevation={3} component={Link} to='/home/treatments'>
                                    <Grid className={classes.grid}>
                                ...
                                <Paper className={classes.topPaper} elevation={3} component={Link} to='/home/check-ups'>
                                    <Grid className={classes.grid}>
                                        <MdNoteAdd size='20' />
                                    ...
                                    .map(
                                        ...
                                        <Grid className={classes.dateGrid} key={item._id}>
                                            <Grid className={classes.open}>
                                                <Grid className={classes.dateitem} onClick={() => navigate(`/home/patients/${item._id}`)} >
                                                    <Typography className={classes.datetext} variant='body1'>{item.fullName}</Typography>
                                                </Grid>
                                                <Grid className={classes.actions}>
                                                <Button className={classes.btn} onClick={() => handleAddTreatment(item)}>Add</Button>
                                                </Grid>
                                            </Grid>
                                        </Grid>
                                        )
                                    ...
                                    .map(
                                        ...
                                        <Grid className={classes.dateGrid} key={item._id}>
                                            <Grid className={classes.open}>
                                                ...
                                                <Grid className={classes.actions}>
                                                    <Button style={{textDecoration: "none"}} onClick={() => handlePatientToUpdate(item)} >< AiFillEdit size="20" color='#3be993' /></Button>
                                                </Grid>
                                            </Grid>
                                        </Grid>
                                        )
